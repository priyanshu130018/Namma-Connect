    ...
    <div className="space-y-6 pb-12 max-w-7xl mx-auto">
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 pt-2">
          {[1, 2, 3].map((n) => (
            <div key={n} className="rounded-3xl border border-slate-100 bg-white p-4 space-y-4 shadow-xs">
        ...
        <div className="p-6 rounded-3xl bg-rose-50 border border-rose-200 text-rose-800 space-y-3 text-center max-w-md mx-auto my-8">
          ...
          <Button
            ...
            size="sm"
            onClick={fetchSaved}
            className="gap-1.5 font-bold text-xs bg-white hover:bg-rose-100/50 border-rose-300 text-rose-700 rounded-xl shadow-xs"
          >
