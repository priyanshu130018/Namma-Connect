      ...
      <div className="pt-28 pb-20 px-6 max-w-6xl mx-auto flex flex-col lg:flex-row gap-12">
        ...
        <div className="lg:w-1/3 space-y-6">
          ...
          <div className="bg-card rounded-2xl p-8 border border-border shadow-sm">
             <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-widest mb-6 px-1">Verification Status</h3>
             <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-primary/10 border border-primary/30 rounded-2xl">
                   <div className="flex items-center gap-3">
                      <FiShield className="text-primary" />
                      <span className="text-xs font-bold text-primary">ID Verified</span>
                   </div>
                ...
                <div className="flex items-center justify-between p-4 bg-surface border border-border rounded-2xl group cursor-help transition-all hover:bg-card hover:border-border">
                   <div className="flex items-center gap-3">
                      ...
                      <span className="text-xs font-bold text-muted-foreground">Global Citizen</span>
                   </div>
          ...
          <form onSubmit={handleSave} className="space-y-8">
            ...
            >
              <div className="flex items-center justify-between border-b border-border pb-8">
                <div>
                   <h2 className="text-3xl font-semibold text-foreground tracking-tight mb-2">My Information</h2>
                   <p className="text-muted-foreground text-sm font-medium">This is used for your bookings and identity verification.</p>
                </div>
                <button 
                  type="button"
              ...
              <div className="pt-10 border-t border-border">
                 <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-[0.2em] mb-8 flex items-center gap-3">
                    <FiMapPin className="text-primary" /> Location Details
                 </h3>
                 <div className="space-y-6">
              ...
              <div className="pt-10 border-t border-border">
                 <h3 className="text-xs font-semibold text-muted-foreground uppercase tracking-[0.2em] mb-8 flex items-center gap-3">
                    <FiShield className="text-primary" /> Security & ID
                 </h3>
                 <div className="bg-surface rounded-[30px] p-8 border border-border/50">
                    ...
                    <p className="text-[9px] font-bold text-muted-foreground mt-4 leading-relaxed italic px-2">
