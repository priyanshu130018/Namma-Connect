...
const statusStyle = {
  ...
  cancelled: { class: "bg-primary/10 text-destructive",      icon: <FiX size={11} /> },
      ...
      <div className="pt-24 pb-20 px-6 flex flex-col items-center">
        <div className="w-full max-w-5xl">
          <header className="mb-12 text-center">
            ...
            <p className="text-muted-foreground font-medium mt-2">Manage your farm stays and your personal travels</p>
          </header>

          {loading ? (
            <div className="flex flex-col items-center justify-center py-20">
              <div className="w-12 h-12 border-4 border-border border-t-primary rounded-full animate-spin mb-4" />
              <p className="text-muted-foreground font-bold uppercase tracking-widest text-xs">Syncing with DB...</p>
            </div>
          ) : (
              ...
              <section>
                <div className="flex items-center justify-between mb-6 px-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-xl font-semibold text-foreground">Bookings Received</h2>
                      <p className="text-xs text-muted-foreground font-bold uppercase tracking-widest mt-0.5">Guests visiting your farm</p>
                    </div>
                  </div>
                ...
                {receivedBookings.length === 0 ? (
                  <div className="bg-card rounded-2xl p-12 border-2 border-dashed border-border text-center opacity-70">
                    <p className="text-muted-foreground font-bold">No guest bookings yet. They'll appear here once tourists book!</p>
                  </div>
                ) : (
              ...
              <section>
                <div className="flex items-center justify-between mb-6 px-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-xl font-semibold text-foreground">My Stays & Travels</h2>
                ...
                {madeBookings.length === 0 ? (
                  <div className="bg-card rounded-2xl p-12 border-2 border-dashed border-border text-center opacity-70">
                    <p className="text-muted-foreground font-bold">You haven't made any bookings yet.</p>
                  </div>
                ) : (
                  <div className="grid gap-4">
