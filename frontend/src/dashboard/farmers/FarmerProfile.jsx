      ...
      <div className="pt-28 pb-20 px-6 max-w-6xl mx-auto flex flex-col lg:flex-row gap-12">
        ...
        <div className="lg:w-1/3 space-y-6">
          ...
          <div className="bg-white rounded-[32px] p-8 border border-slate-200 shadow-sm">
             <h3 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-6 px-1">Trust Badges</h3>
             <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-amber-50 border border-amber-100 rounded-2xl">
                   <div className="flex items-center gap-3">
                      ...
                      <span className="text-xs font-bold text-amber-900">KYC Verified</span>
                   </div>
                ...
                <div className="flex items-center justify-between p-4 bg-slate-50 border border-slate-100 rounded-2xl group cursor-help transition-all hover:bg-white hover:border-slate-200">
                   <div className="flex items-center gap-3">
                      ...
                      <span className="text-xs font-bold text-slate-500">Premium Host</span>
                   </div>
          ...
          <form onSubmit={handleSave} className="space-y-8">
            ...
            >
              <div className="flex items-center justify-between border-b border-slate-50 pb-8">
                <div>
                   <h2 className="text-3xl font-black text-slate-900 tracking-tight mb-2">Farmer Profile</h2>
                   <p className="text-slate-400 text-sm font-medium">Manage your personal and farm-related contact details.</p>
                </div>
                <button 
                  type="button"
                  onClick={() => setIsEditing(!isEditing)}
                  className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all ${isEditing ? 'bg-amber-500 text-white shadow-lg shadow-amber-200' : 'bg-slate-50 text-slate-400 hover:bg-slate-100'}`}
                >
                   <FiEdit3 size={24} />
                </button>
              </div>
              ...
              <div className="pt-10 border-t border-slate-100">
                 <h3 className="text-xs font-black text-slate-400 uppercase tracking-[0.1em] mb-8 flex items-center gap-3">
                    <FiMapPin className="text-amber-500" /> Residential Address
                 </h3>
                 <div className="space-y-6">
              ...
              <div className="pt-10 border-t border-slate-100">
                 <h3 className="text-xs font-black text-slate-400 uppercase tracking-[0.1em] mb-8 flex items-center gap-3">
                    <FiShield className="text-amber-500" /> Security & Identity
                 </h3>
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 ...
                 <p className="text-[10px] font-bold text-slate-400 mt-6 leading-relaxed italic border-l-2 border-amber-200 pl-4">
